...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleMedium: const TextStyle().copyWith(fontSize: TSizes.fontSize18, fontWeight: TSizes.fontWeight600, color: TColors.primary, fontFamily: TTexts.fontFamily, letterSpacing: TSizes.letterSpacingSm, height: TSizes.lineHeight22 / TSizes.fontSize16),
    ...
    labelSmall: const TextStyle().copyWith(fontSize: TSizes.fontSize12, fontWeight: TSizes.fontWeight400, color: TColors.primary, fontFamily: TTexts.fontFamily, letterSpacing: TSizes.letterSpacingSm, height: TSizes.lineHeight22 / TSizes.fontSize12),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleMedium: const TextStyle().copyWith(fontSize: TSizes.fontSize18, fontWeight: TSizes.fontWeight600, color: TColors.white, fontFamily: TTexts.fontFamily, letterSpacing: TSizes.letterSpacingSm, height: TSizes.lineHeight22 / TSizes.fontSize16),
    ...
    labelSmall: const TextStyle().copyWith(fontSize: TSizes.fontSize12, fontWeight: TSizes.fontWeight400, color: TColors.white.withOpacity(0.8), letterSpacing: TSizes.letterSpacingSm, height: TSizes.lineHeight22 / TSizes.fontSize12),
  );
}